...
const writeStructuredData = (locales, visualization = "", structuredData = null) => {
    if (structuredData === null) {
        structuredData = data[locales.lang] || data.en;
        if (visualization !== "") {
            structuredData = structuredData.hasPart.find(
                (part) => part['@id'] === visualization
            );
        }
    }
    if (visualization !== "") {
        structuredData.isPartOf = data[locales.lang] || data.en;
    }
...
const build = function(navbar, locales, configuration, structuredData = null) {
    ...
    writeStructuredData(locales, navConfig.visualization, structuredData);
};

window.buildNavigation = build;
window.writeStructuredData = writeStructuredData;
